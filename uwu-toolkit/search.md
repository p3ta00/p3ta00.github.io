...
const wikiPages = [
  ...
  },
  {
    ...
    category: "Modules",
    content: "modules ad auxiliary enumeration exploits post payloads impacket bloodyad impacket/psexec impacket/secretsdump impacket/wmiexec bloodyad/genericall bloodyad/setpassword kerberoast asreproast bloodhound certipy netexec adcs_auto delegation_exploit evil_winrm password_spray rbcd_auto bloodyad_validate targeted_kerberoast smb_shares smb_read enum4linux ntlm_coerce hashcrack autoenum portscan dns_enum web_fuzz linpeas pspy reverse_shells donut aspx_shell sebackup_dump seimpersonate"
  },
  {
